  ...
  return (
    <div className="max-w-lg mx-auto my-8">
      <progress
        ...
        max={count}
        id="progress"
        className="bg-zinc-100 rounded-full w-full mb-1 h-[8px] progress"></progress>

      <div className="flex items-center justify-between font-geistmono">
        <p className="text-zinc-500">
          <span className="inline-block font-semibold mr-2 text-zinc-700">Question:</span> {index} /{' '}
          {count}
        </p>
        <p className="text-zinc-500">
          <span className="inline-block font-semibold mr-2 text-zinc-700">Points:</span>{' '}
