...
export default function Summary() {
  ...
  return (
    <header className="flex flex-col items-center justify-center text-center gap-8">
      <h1 className="font-geistmono text-xl font-bold my-6">Quiz Completed!</h1>
      <p className="text-sm text-zinc-600  max-w-sm">You scored {totalPoints} out of 100 points.</p>
